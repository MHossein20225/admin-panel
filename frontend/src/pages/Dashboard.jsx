    ...
    return (
        <div className="flex flex-col items-center w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-4 w-full p-4">
                <div
                    className="w-full lg:w-1/3 border border-(--border-color) rounded-2xl p-4 sm:p-6 flex flex-col gap-4">
                ...
                <div
                    className="w-full lg:w-2/3 border border-(--border-color) rounded-2xl p-4 sm:p-6 flex flex-col gap-4 min-h-80">
